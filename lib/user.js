module.exports.find = function (username, callback) {
  var options = {
    method: "GET",
    path: "/rest/usermanagement/latest/user?username=" + username
  };
...
module.exports.create = function (firstname, lastname, displayname, email, username, password, callback) {
  ...
  var options = {
    ...
    "path": "/rest/usermanagement/latest/user"
  };
...
module.exports.changepassword = function (username, password, callback) {
  ...
  var options = {
    "method": "PUT",
    "data": JSON.stringify(payload),
    "path": "/rest/usermanagement/latest/user/password?username=" + username
  };
...
module.exports.groups = function (username, callback) {
  ...
  var options = {
    method: "GET",
    path: "/rest/usermanagement/latest/user/group/nested?username=" + username
  };
...
module.exports.authenticate = function (username, password, callback) {
  ...
  var options = {
    method: "POST",
    data: JSON.stringify(payload),
    path: "/rest/usermanagement/latest/authentication?username=" + username
  };
