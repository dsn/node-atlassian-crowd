...
function AtlassianCrowd(options) {
  ...
  if(!settings.port) { 
    settings.port = uri.port || (uri.protocol == "https:") ? 443 : 80;
  }
}
...
AtlassianCrowd.prototype.search = function (type, query, callback) {
  ...
  var options = {
    "method": "GET",
    "path": "/rest/usermanagement/latest/search?entity-type=" + type + "&restriction=" + query
  };
...
AtlassianCrowd.prototype.ping = function (callback) {
  var options = {
    method: "GET",
    path: "/rest/usermanagement/latest/config/cookie"
  };
